...
class LinkedList:
    ...
    def add_to_tail(self, value):
        # if self.head is not None, so the LinkedList is not empty:
        ...
        # if self.head is none (the LinkedList is empty):
        else:
    ...
    def remove_head(self):
        # if self.head is not None (the LinkedList is NOT empty):
        if self.head is not None:
